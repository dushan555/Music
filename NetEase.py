...
class NetEase:
    ...
    def req_search(self, _word, index):
        ...
        resp = requests.post(req_url, headers=self.get_headers(), data=req_data)
        ...
        for song in _list:
            ...
            html += f'<div class="item">\
                        ...
                        <div class="music-bottom">\
                            ...
                            <div class="level inline text font10">{song.level}</div>\
                        </div>\
                    </div>'
        print(html + '</div>')
    ...
    def echo_search(self):
        ...
        songList = self.req_search(word, search_index)
    ...
    def echo_recommend(self):
        ...
        if songList:
            self.echo_html(songList, '每日歌曲推荐')
        else:
            print(f'未找到!')
...
if __name__ == '__main__':
    ...
    if len(sys.argv) > 1:
        ...
        netEase.echo_recommend()
        # print(netEase.get_song('168087'))
